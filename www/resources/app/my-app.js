    ...
    if (params && imgFor.assetList) {
        ...
        if (params.Icon && pattern.test(params.Icon)) {
            ...
            if (splitted.length > 1) {
                ...
                assetImg = '<div class="item_asset_img bg-boatwatch"><div class="text-a-c vertical-center user_f_l color-white">'+one+two+'</div></div>';            
            }else{
                assetImg = '<div class="item_asset_img bg-boatwatch"><div class="text-a-c vertical-center user_f_l color-white">'+params.Name[0]+params.Name[1]+'</div></div>';            
            }
    ...
    JSON1.request(url, function(result) {           
            ...
            if(result.MajorCode == '000') {
                ...
                if (hisArray.length === 0) {
                    ...
                    window.PosMarker[TargetAsset.ASSET_IMEI] = L.marker([latlng.lat, latlng.lng], {icon: Protocol.MarkerIcon[1]}); 
